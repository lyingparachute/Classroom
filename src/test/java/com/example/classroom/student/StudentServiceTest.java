...
class StudentServiceTest {
    ...
    @Nested
    class GetAllStudentsFromRequest {
        @Test
        void returnsFilteredAndSortedStudentsPage_givenUserWithRoleTeacher() {
            // Given
            int pageNo = 1;
            int pageSize = 2;
            String sortField = "name";
            ...
            User user = initData.createUserWithTeacherRole(teacher1);
