...
@Slf4j
public final class InvalidOldPasswordExistException extends RuntimeException {
    ...
    public InvalidOldPasswordExistException(String message) {
        super(message);
        log.warn(LOG_ERROR_EXCEPTION_OCCURRED_MSG, message);
    }

    public InvalidOldPasswordExistException(String message, Throwable cause) {
        super(message, cause);
